...
template <class D> class matrix2{
  ...
  matrix2() {};                  // private ctor's
  matrix2(int newmaxsize) {matrix2(newmaxsize,newmaxsize);};
public:
  matrix2(int newmaxsize, int newactualsize)  { // the only public ctor
  ...
  void settoproduct(matrix2& left, matrix2& right)  {
  ...
  void copymatrix2(matrix2&  source)  {
